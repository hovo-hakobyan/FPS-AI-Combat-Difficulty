...
public:
	...
	UPROPERTY(EditDefaultsOnly, Category = Projectile)
		TSubclassOf<class AAI_AccuracyProjectile> ProjectileClass;
...
private:
	...
	//Component in order for the AI to detect the player
	class UAIPerceptionStimuliSourceComponent* pStimulus;
	void SetupStimulus();
